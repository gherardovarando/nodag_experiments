...
est_methods <- list(
  ...
  "pc-0.01-cs" = function(x) est_pcalg(x, alpha = 0.01, conservative = TRUE, solve.confl = TRUE),
  ...
  "fnodag-0.3" = function(x) est_fnodag(x, lambda = 0.3),
  "fnodag-0.2" = function(x) est_fnodag(x, lambda = 0.2),
  "fnodag-0.1" = function(x) est_fnodag(x, lambda = 0.1),
